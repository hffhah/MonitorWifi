...
public class WifiAdmin {
	...
	public int getNetworkId() {
		return (getmWifiInfo() == null) ? 0 : getmWifiInfo().getNetworkId();
	}
	...
	public int getIPAddress() {
		return (getmWifiInfo() == null) ? 0 : getmWifiInfo().getIpAddress();
	}
	...
	public String getMacAddress() {
		return (getmWifiInfo() == null) ? "NULL" : getmWifiInfo().getMacAddress();
	}

	// 得到接入点的BSSID
	public String getBSSID() {
		return (getmWifiInfo() == null) ? "NULL" : getmWifiInfo().getBSSID();
	}

	// 得到接入点的SSID
	public String getSSID() {
		return (getmWifiInfo() == null) ? "NULL" : getmWifiInfo().getSSID();
	}

	// 得到WifiInfo的所有信息包
	public String getWifiInfo() {
		return (getmWifiInfo() == null) ? "NULL" : getmWifiInfo().toString();
	}
